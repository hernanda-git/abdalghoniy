...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="content" id="overview">
      ...
      {streamError && !error && <div className="notice notice-warn"><CircleAlert size={16} />{streamError} REST fallback remains active.</div>}
